...
class ImuController():
    ...
    def shutdown(self):
        """Handle IMU shutdown"""    
        logger.warning("SHUTTING IMU DOWN...")
        # Remove interrupt
        GPIO.remove_event_detect(self.IMU_INT1_PIN) 

        # Set accelerometer and gyroscope to power down mode
        self._imu.accelerometer_data_rate = Rate.RATE_SHUTDOWN
        self._imu.gyro_data_rate = Rate.RATE_SHUTDOWN
